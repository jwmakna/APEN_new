...
# =====================================================================
# 방법7_3term_AR_gurobi_figure.py
#
# 목적: "방법7 - Additive CVaR" (보고서 3.2.7절 수식)을 원본 3항(논문 그대로, PC=rate*DA) 수익식
...
for ratio_label, sweep_w1, sweep_w2 in RATIO_LIST:
    ...
    for hour in range(HOURS_PER_DAY):
        ...
        shortage_price_this_hour_swc = PENALTY_RATE * da_this_hour   # 3항 부족비용 (이 파일과 동일)
...
plt.title("Fig.3 (3항) CVaR 적용 전/후 비교 - z03 블록18")
plt.tight_layout()
plt.savefig("fig3_ar_cvar_compare.png", dpi=150)
print("저장 완료: fig3_ar_cvar_compare.png")
plt.show()
...
for penalty_rate_sw in PENALTY_LIST:
    ...
    for hour in range(HOURS_PER_DAY):
        ...
        shortage_price_this_hour_p5c = penalty_rate_sw * da_this_hour   # 3항 부족비용, 이번엔 penalty_rate_sw 사용
...
plt.suptitle("Fig.5 (3항) CVaR 적용 전/후 비교 - z03 블록18 (W1=W2=1)")
plt.tight_layout()
plt.savefig("fig5_ar_cvar_compare.png", dpi=150)
print("저장 완료: fig5_ar_cvar_compare.png")
plt.show()