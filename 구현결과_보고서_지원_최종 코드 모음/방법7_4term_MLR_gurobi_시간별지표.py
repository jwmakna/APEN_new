...
shortage_price_train = ( 
    PENALTY_RATE * train_da_price
    + train_rt_price
)
...
MODEL_LABEL = "Proposed MLR (4-term)"
OUTPUT_TAG = "proposed_mlr_4term"
    ...
    for hour_index in range(HOURS_PER_DAY):
        ...
        realized_profit_i = (
            ...
            * (
                da_i * commitment_i
                + rt_i * surplus_i
                - (penalty_cost_i + rt_i) * shortage_i
            )
        )
        ...
        profit_commit_full = (
            ...
            * (
                ...
                - (penalty_cost_i + rt_i) * shortage_if_full
            )
        )
