...
for ratio_label, sweep_w1, sweep_w2 in RATIO_LIST:
    ...
    shortage_price_train_swc = PENALTY_RATE * train_da_price   # 3항 부족비용 (이 파일과 동일)
...
plt.title("Fig.6 (3항) CVaR 적용 전/후 비교 - z03 블록18")
plt.tight_layout()
plt.savefig("fig6_mlr_cvar_compare.png", dpi=150)
print("저장 완료: fig6_mlr_cvar_compare.png")
plt.show()
...
for penalty_rate_sw in PENALTY_LIST:
    ...
    shortage_price_train_p8c = penalty_rate_sw * train_da_price   # 3항 부족비용, 이번엔 penalty_rate_sw 사용
...
plt.suptitle("Fig.8 (3항) CVaR 적용 전/후 비교 - z03 블록18 (W1=W2=1)")
plt.tight_layout()
plt.savefig("fig8_mlr_cvar_compare.png", dpi=150)
print("저장 완료: fig8_mlr_cvar_compare.png")
plt.show()