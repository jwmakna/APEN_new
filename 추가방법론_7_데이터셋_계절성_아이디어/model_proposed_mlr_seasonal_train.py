...
# 자동으로 계산한다 - 학습구간이 항상 테스트구간과 같은 달력상 계절에
# 오게 되고, 테스트기간의 실제 가격은 들여다보지 않으므로 leakage가 아니다.
...
print()
print(f"=== 논문 제안 모형 MLR [계절 매칭 학습구간: 테스트 {YEAR_OFFSET_DAYS}일 전부터 {TRAIN_LENGTH_DAYS}일] - 블록18 결과 ===")
