...
train_da_price_norm = train_da_price / train_price_baseline    # [계절 정규화] 정규화된 DA가격 (학습 MILP 목적함수 전용)
train_rt_price_norm = train_rt_price / train_price_baseline    # [계절 정규화] 정규화된 RT가격 (학습 MILP 목적함수 전용)
