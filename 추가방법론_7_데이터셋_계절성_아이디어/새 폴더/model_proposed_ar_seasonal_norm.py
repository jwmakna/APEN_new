...
for day_index in range(n_train_days):                              # 학습 날짜를 하나씩 순서대로
    for hour in range(HOURS_PER_DAY):                                 # 시간대를 하나씩 순서대로
        train_da_price_norm[day_index, hour] = train_da_price[day_index, hour] / train_baseline[day_index]
        train_rt_price_norm[day_index, hour] = train_rt_price[day_index, hour] / train_baseline[day_index]
