...
MODEL_FILE = r"D:\Users\Downloads\mlr 구로비 라이선스 돌려보려고 - CVaR 도입 - step3_람다스윕(람다스윕때문에CVAR_ALPHA랑_LAMBDA 변수 설정 달라짐 주의\model_proposed_ar_profit_change.py"

MERGED_FILE = (
    r"D:\Users\Downloads\mlr 구로비 라이선스 돌려보려고 - CVaR 도입 - step3_람다스윕(람다스윕때문에CVAR_ALPHA랑_LAMBDA 변수 설정 달라짐 주의\merged_for_simulation_z03.csv"
)
